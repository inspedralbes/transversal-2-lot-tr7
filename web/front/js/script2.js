...
Vue.component('vue-header', {
  ...
  <div class="header">
    ...
    <b-modal id="challenge" title="Challenges">
      ...
      <div id="pending" class="challengeContent" v-model="challenges.idChallengeGame">
        <table>
          <th>Sender</th>
          <th>Receiver</th>
          <th>Data</th>
          ...
          <tr v-for="pending in challenges.pending">
            ...
            <td>{{pending.date}}</td>
            <td><b-button @click="getChallenge" v-bind:value=pending.idGame>Play Challenge</b-button></td>
          </tr>
        </table>
      </div>
    </b-modal>
    ...
    getChallenge: function () {
      fetch(
        `http://trivial7.alumnes.inspedralbes.cat/laravel/public/api/get-game`,
        {
          ...
          method: 'post',
          body: JSON.stringify({
            id: parseInt(this.challenges.idChallengeGame),
          }),
        }
      );
    },
